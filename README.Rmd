...
Here we will explore the usage and (substandard) performance of this package. To achieve this, we will first load the _prepair_ package. We will also load some other packages for working with spatial vector data.
